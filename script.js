...
function transformRawData(aggregatedScoresData, questionDetailsData) {
    ...
    // Check unique AssessmentNames in QuestionDetails
    ...
    studentQuestionDetails.forEach(qRow => {
        ...
        if (!quizzesByAssessment[assessmentSource][assessmentName]) {
            quizzesByAssessment[source][name] = []; // This line has a potential bug: should be quizzesByAssessment[assessmentSource][assessmentName]
        }
